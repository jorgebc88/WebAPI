...
app.service('adminService', ['$http', function ($http){
  ...
  var addCamera = function (location, latitude, longitude, ip, pointingAt, active){
    return $http.post('http://localhost:8080/REST-API/camera/newCamera', {"location": location, "latitude": latitude, "longitude": longitude, "ip": ip, "active": active, "pointingAt": pointingAt});
  };
